...
select target_name,prank_id,evilness_score from (
select target_name, prank_id,evilness_score,rank() 
over(partition by target_name ORDER by evilness_score desc, created_at desc ) 
  as ranking from grinch_prank_ideas)
where ranking=1
